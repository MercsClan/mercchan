...
module.exports = message => {
  ...
  let embed = new Discord.RichEmbed()
    ...
    .addField('Message Content', message.content ? message.content : 'Unknown');
  auditlogchannel.send(embed).catch(err => console.log(err));

  console.log(
    `[${message.guild}] A message sent by ${message.author.username} has been deleted: ${message.content}.`
  );
  return;
};
