...
module.exports.noLogChannel = (message, perm) => {
  let embed = new Discord.RichEmbed()
    ...
    .setColor(config.red)
    .setDescription(
      'Sorry, I could not find the `#audit-log` channel. This notification was unable to be sent!'
    );
...
module.exports.noReportChannel = (message, perm) => {
  let embed = new Discord.RichEmbed()
    ...
    .setColor(config.red)
    .setDescription(
      'Sorry, I could not find the `#reports` channel. This report was unable to be sent!'
    );
...
module.exports.noPermissions = (message, perm) => {
  let embed = new Discord.RichEmbed()
    .setTitle('An error has occurred!')
    .setDescription(
      `You have insufficent permissions to run this command.\nYou require the permission flag of **${perm}**!`
    )
    .setColor(config.red);
...
module.exports.noTakovMap = (message) => {
  let embed = new Discord.RichEmbed()
    .setTitle('An error has occurred!')
    .setDescription(
      'Please provide a map for the tarkov command. ex: !tarkov customs'
    )
    .setColor(config.red);
...
module.exports.provideNumber = (message) => {
  let embed = new Discord.RichEmbed()
    .setTitle('An error has occurred!')
    .setDescription(
      'Please provide a number of messages you would like to delete.'
    )
    .setColor(config.red);
...
module.exports.emptyMessage = (message) => {
  let embed = new Discord.RichEmbed()
    .setTitle('An error has occurred!')
    .setDescription(
      'Please specify the message you would like to send, you cannot send an empty message.'
    )
    .setColor(config.red);
...
module.exports.invalidClientID = (message) => {
  let embed = new Discord.RichEmbed()
    .setTitle('An error has occurred!')
    .setDescription(
      'Please specify a client ID, the field cannot be left blank.'
    )
    .setColor(config.red);
...
module.exports.incorrectChannel = (message) => {
  let embed = new Discord.RichEmbed()
    .setTitle('An error has occurred!')
    .setDescription(
      'You have sent this command in the wrong channel, try `#tweet`.'
    )
    .setColor(config.red);
...
module.exports.commandNotEnabled = (message) => {
  let embed = new Discord.RichEmbed()
    .setTitle('An error has occurred!')
    .setDescription(
      'This command is not enabled, you can turn this on via the `config.json` file.'
    )
