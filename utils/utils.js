...
module.exports = {
  ...
  tokenizer: function (model, prompt) {
    if (model === "chatgpt") {
      ...
      if (model === "davinci") {
        ...
        else if (model === "Babbage")
          tokens = encoderBabbage.encode(prompt).length;
  ...
  pricing: function (model, number, resolution) {
    ...
    } else if (model === "chatgpt") cost = number * (0.002 / 1000);
    else if (model === "davinci") cost = number * (0.02 / 1000);
    else if (model === "curie") cost = number * (0.002 / 1000);
